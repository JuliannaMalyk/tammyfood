(() => {
    ...
    function initSliders() {
        if (document.querySelector(".dish__items")) new swiper_core_Swiper(".dish__items", {
            ...
            navigation: {
                prevEl: ".dish-swiper-buttos .swiper-button--prev",
                nextEl: ".dish-swiper-buttos .swiper-button--next"
            },
            on: {}
        });
    }
